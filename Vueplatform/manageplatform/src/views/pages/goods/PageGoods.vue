  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderlist" stripe border style="width: 100%">
        ...
        <el-table-column prop="is_send" label="是否缺货"></el-table-column>
...
export default {
  ...
  methods: {
    async getOrderList () {
      const { data } = await this.$http.get('https://www.liulongbin.top:8888/api/private/v1/orders', {
    ...
    async showProgressBox () {
      const { data } = await this.$http.get('https://www.liulongbin.top:8888/api/private/v1/kuaidi/804909574412544580')
      if (data.meta.status !== 200) {
        return this.$message.error(data.meta.msg)
      }
