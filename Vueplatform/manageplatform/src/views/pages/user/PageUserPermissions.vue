  ...
  methods: {
    dbDataToWebData () {
      ...
      dbData.directive.forEach(directive => {
        ...
        // directiveJson.hasOwnProperty(directive.pageId)
        if (!Object.prototype.hasOwnProperty.call(directiveJson, directive.pageId)) {
    ...
    pagePathSuggest (queryString, cb) {
      const results = this.selectOptions.pathOption.reduce((paths, _pathName) => {
